 ...
 */
@Slf4j
public class ActiveMqCanceller implements ActiveMqTaskRequestHandler<TaskCancelRequest> {

    private final TaskRepository taskRepository;
    private final TaskScheduleSelector taskScheduleSelector;

    public ActiveMqCanceller(TaskRepository taskRepository, TaskScheduleSelector taskScheduleSelector) {
